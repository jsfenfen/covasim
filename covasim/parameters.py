...
def make_pars():
    ...
    pars['beta_layer']   = {'h': 1.7,  's': 0.8, 'w': 0.8, 'c': 0.3} # Per-population beta weights; relative
    pars['contacts']     = {'h': 4,    's': 11,  'w': 8,   'c': 20}  # Number of contacts per person per day, estimated
